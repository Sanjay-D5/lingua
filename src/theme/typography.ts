/**
 * Typography tokens from the design system (prompt_material/01-design-system.png).
 * Keep in sync with the `.text--*` classes in src/global.css.
 *
 * Prefer the `text--*` className utilities on <Text>. Reach for these
 * constants only for RN components/props that don't accept className —
 * see AGENTS.md "Style Exception Rules".
 */
